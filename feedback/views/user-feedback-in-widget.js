...
(function() {
  ...
  define(['knockout', 'components/dialog', 'odo/auth/current-user'], function(ko, Dialog, user) {
    ...
    return UserFeedbackInWidget = (function() {
      ...
      UserFeedbackInWidget.prototype.activate = function(activationData) {
        ...
        return $.get("/user-feedback-in-widget/" + dashboardUser.id).then((function(_this) {
